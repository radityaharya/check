...
function PasskeysTab() {
  ...
  return (
    <div className="space-y-6">
      <div className="text-xs text-terminal-muted mb-4">
        Passkeys provide passwordless authentication using your device's biometrics or security
        key
      </div>
...
function ProbesTab() {
  ...
  const [regeneratedToken, setRegeneratedToken] = useState<{ id: number; token: string } | null>(
    null
  );
  ...
  return (
    <div className="space-y-6">
      <div className="text-xs text-terminal-muted mb-4">
        Manage multi-region probes. Create probes and generate authentication tokens for
        deployment.
      </div>
