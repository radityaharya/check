...
// TimescaleDB instances that don't have SSL enabled.
func normalizeTimescaleConnString(connString string) string {
...
func (d *TimescaleDB) Close() error {
	return d.db.Close()
}
...
func (d *TimescaleDB) SetSetting(key, value string) error {
	_, err := d.db.Exec(`
...
func (d *TimescaleDB) GetCheckSnapshot(checkID int64) (*models.CheckSnapshot, error) {
	var filePath sql.NullString
	var takenAt sql.NullTime
	var lastError sql.NullString
...
func (d *TimescaleDB) UpsertCheckSnapshot(snapshot *models.CheckSnapshot) error {
	_, err := d.db.Exec(`
...
func (d *TimescaleDB) GetAllCheckSnapshots() ([]models.CheckSnapshot, error) {
	rows, err := d.db.Query(`
...
func (d *TimescaleDB) GetGroup(id int64) (*models.Group, error) {
	var g models.Group
...
func (d *TimescaleDB) CreateGroup(g *models.Group) error {
	err := d.db.QueryRow(`
...
func (d *TimescaleDB) UpdateGroup(g *models.Group) error {
	_, err := d.db.Exec(`UPDATE groups SET name = $1, sort_order = $2 WHERE id = $3`, g.Name, g.SortOrder, g.ID)
	return err
}

func (d *TimescaleDB) DeleteGroup(id int64) error {
...
func (d *TimescaleDB) GetTag(id int64) (*models.Tag, error) {
	var t models.Tag
...
func (d *TimescaleDB) CreateTag(t *models.Tag) error {
	err := d.db.QueryRow(`
...
func (d *TimescaleDB) UpdateTag(t *models.Tag) error {
	_, err := d.db.Exec(`UPDATE tags SET name = $1, color = $2 WHERE id = $3`, t.Name, t.Color, t.ID)
	return err
}

func (d *TimescaleDB) DeleteTag(id int64) error {
	_, err := d.db.Exec(`DELETE FROM tags WHERE id = $1`, id)
	return err
}

func (d *TimescaleDB) GetCheckTags(checkID int64) ([]models.Tag, error) {
	rows, err := d.db.Query(`
...
func (d *TimescaleDB) HasUsers() (bool, error) {
	var count int
...
func (d *TimescaleDB) UpdateAPIKeyLastUsed(id int64) error {
	_, err := d.db.Exec(`UPDATE api_keys SET last_used_at = CURRENT_TIMESTAMP WHERE id = $1`, id)
	return err
}

func (d *TimescaleDB) DeleteAPIKey(id int64) error {
...
func (d *TimescaleDB) DeleteUserSessions(userID int64) error {
...
func (d *TimescaleDB) GetWebAuthnCredentialsByUserID(userID int64) ([]models.WebAuthnCredential, error) {
...
func (d *TimescaleDB) GetWebAuthnCredentialByID(credID []byte) (*models.WebAuthnCredential, error) {
	var c models.WebAuthnCredential
...
func (d *TimescaleDB) UpdateWebAuthnCredentialSignCount(credID []byte, signCount uint32) error {
